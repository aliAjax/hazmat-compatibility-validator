...
func (b Rulebook) Validate() error {
	...
	if b.EffectiveUntil != nil && !b.EffectiveUntil.After(b.EffectiveFrom) {
		return fmt.Errorf("invalid rulebook period")
	}
...
func (b Rulebook) EffectiveAt(at time.Time) bool {
	return !at.Before(b.EffectiveFrom) && (b.EffectiveUntil == nil || at.Before(*b.EffectiveUntil)) && (b.WithdrawnAt == nil || at.Before(*b.WithdrawnAt))
}
